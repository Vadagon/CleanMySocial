...
export const EXTENSIONS: Extension[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Open legacy unsubscribe pages or email requests for you to finish",
    ...
    limitations: [
      ...
      "Automatic unsubscribe works only when a sender provides a supported one-click endpoint. Other unsubscribe pages or email requests require you to finish them.",
    ...
    faq: [
      { question: "Can I try Gmail Cleaner for free?", answer: "Yes. The free plan includes 10 Fast actions followed by 10 Standard actions each day. Paid access removes the daily limit and unlocks Super Speed." },
      ...
      { question: "Does unsubscribe always happen automatically?", answer: "No. Supported one-click unsubscribe requests can complete automatically. When a sender requires a webpage or email confirmation, Gmail Cleaner opens it for you to finish." },
    ...
    licenseGroup: "cleanmysocial",
    freePlan: {
      allowance: "20 cleanup actions per day",
      headline: "Gmail cleanup is free to use",
      upgradeMessage: "Upgrade for unlimited cleanup and Super Speed.",
    },
