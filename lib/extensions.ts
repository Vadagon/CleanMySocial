...
export const EXTENSIONS: Extension[] = [
  ...
  },
  {
    slug: "gmail-cleaner",
    detailHeadings: {
      features: "What Gmail Cleaner can clean",
      steps: "How to clean newsletters and unwanted email",
      limitations: "Gmail access and important limitations",
      faq: "Gmail Cleaner privacy and billing FAQ",
    },
    shortName: "Gmail Cleaner",
    promoName: "Gmail Inbox",
    promoDescription: "Unsubscribe and bulk-delete unwanted email",
    installedHighlights: [
      "Find newsletters and mailing lists",
      "Unsubscribe from selected senders",
      "Bulk-delete old email by sender",
    ],
    installedPlatform: "Gmail",
    installedUrl: "https://mail.google.com/",
    name: "Gmail Cleaner – Bulk Delete Emails & Mass Unsubscribe – CleanMyInbox",
    tagline: "Clean your Gmail inbox: find newsletters, unsubscribe from unwanted senders, and bulk-delete their past emails.",
    description:
      "Review mailing lists in Chrome's side panel, unsubscribe from selected senders, delete their existing messages with age and safety filters, and manage blocks as ordinary Gmail filters.",
    icon: "/extensions/gmail-cleaner.png",
    users: 0,
    usersUpdated: "September 11, 2026",
    features: [
      "Find senders Gmail identifies as newsletters and mailing lists",
      "Submit supported one-click unsubscribe requests for selected senders",
      "Send supported unsubscribe emails from your Gmail account",
      "Bulk-move matching messages to Gmail Trash",
      "Keep starred or important messages and filter deletion by age",
      "Create, review, and remove Gmail filters that block future mail",
    ],
    steps: [
      "Open Gmail in Chrome and open Gmail Cleaner from the extension icon.",
      "Connect your Google account through Google's consent screen.",
      "Scan for mailing lists, then select the senders you want to clean.",
      "Choose unsubscribe, delete, or both, review the options, and start the cleanup.",
    ],
    limitations: [
      "Google asks you to authorize mailbox modification and Gmail filter settings; CleanMySocial never receives your Google token.",
      "Automatic unsubscribe works through a supported one-click endpoint or an unsubscribe email sent from your Gmail account. Senders without either method are blocked with a removable Gmail filter instead.",
      "Deleted messages are moved to Gmail Trash and remain subject to Gmail's retention behavior.",
      "The mailing-list scan depends on Gmail's classification and may not identify every promotional sender.",
    ],
    faq: [
      { question: "Can I try Gmail Cleaner for free?", answer: "Yes. Scanning is free, with 100 emails moved to Trash and 5 Super Unsubscribes per local day. Paid access removes those daily limits; every cleanup already runs at full speed." },
      { question: "Does CleanMySocial receive my emails?", answer: "No. Gmail data is exchanged directly between the extension and Google's Gmail API. CleanMySocial receives only license checks and privacy-limited technical diagnostics." },
      { question: "Does unsubscribe always happen automatically?", answer: "Supported one-click requests and sender-provided unsubscribe emails are handled automatically. When neither is available, Gmail Cleaner creates a removable Gmail filter that sends future mail from that sender to Trash." },
      { question: "Is Gmail Cleaner made by Google?", answer: "No. Gmail Cleaner is an independent CleanMySocial product and is not affiliated with or endorsed by Google." },
    ],
    storeId: "hconkejfhepopjpgmpdflaindmlcpkng",
    storeUrl: "https://chromewebstore.google.com/detail/hconkejfhepopjpgmpdflaindmlcpkng",
    licenseGroup: "cleanmysocial",
    freePlan: {
      allowance: "100 deletions and 5 Super Unsubscribes per day",
      headline: "Gmail cleanup is free to use",
      upgradeMessage: "Upgrade to remove the daily cleanup limits.",
    },
    plans: singlePlan("gmail-cleaner"),
  },
  {
    slug: "cleanfeed",
    detailHeadings: {
